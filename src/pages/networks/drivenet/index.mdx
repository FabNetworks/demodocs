...
*Given you have already acquired your connection details, start from the middle of tutorial B2 when you connect to the web console for the first time. You can stop once your gateway is connected in tutorial B5. To recap, the key steps are: (1) log in to the IBM Blockchain Platform web console using your administration userid and password; (2) click the CA node and select 'Associate Identity', supplying the enrollment user id and password from the Developer details section; (3) click the peer node and select 'Associate Identity' and supply the same identity; (4) download the identity file from the web console's wallet, and use it to create a wallet in the VS Code extension; (5) create and connect to a DriveNet gateway in the VS Code extension, using the gateway file from the developer details section and the wallet you just created.*
...
**Have you enrolled your identity with the network?** This section requires you to have already enrolled with the DriveNet CA and peer, which you should have done during the B tutorials in the last section. To recap, the key steps are: (1) log in to the IBM Blockchain Platform web console using the administration userid and password; (2) click the CA node and select 'Associate Identity', supplying the enrollment user id and password from the Developer details section; (3) click the peer node and select 'Associate Identity' and supply the same identity. Now log off the web console and continue the demo.
